...
public final class MoEngageInitializer: NSObject {
    ...
    private static func updateSDKConfig(sdkConfig: MoEngageSDKConfig) {
        sdkConfig.setPartnerIntegrationType(integrationType: MoEngagePartnerIntegrationType.none)
    }
    
    private static func trackPluginTypeAndVersion(sdkConfig: MoEngageSDKConfig) {
        let integrationInfo = MoEngageIntegrationInfo(pluginType: MoEngageJournifyConstant.journify, version: MoEngageJournifyConstant.journifyVersion)
